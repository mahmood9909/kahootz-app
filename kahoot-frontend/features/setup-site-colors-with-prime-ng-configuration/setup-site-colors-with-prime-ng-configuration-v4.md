...
1. No default requirement to make button black — currently it's green; make it match PrimeNG default theming (black and white).
2. Keep the modern coloring, not pure #000000 and #ffffff.
4. Shadcn support planned; for now change colors site-wide.
5. Default to black; will review and decide on accent later.
6. Keep gray background for now.
