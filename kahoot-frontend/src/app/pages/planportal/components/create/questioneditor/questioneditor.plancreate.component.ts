...
import { CalculationAlgorithm, QType } from '@app-types';
...
@Component({
  selector: 'planportal-questioneditor',
  ...
  templateUrl: './questioneditor.plancreate.component.html',
})
export class QuestioneditorComponent {
  readonly stateService = inject(QuestionStateManagementService);

  readonly question = computed(() => this.stateService.activeQuestionState());
